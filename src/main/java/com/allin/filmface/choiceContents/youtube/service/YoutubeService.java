...
//
//    public List<Youtube> getYoutubeContentsByQuery(String query, String emotionResult, Integer memberNo) {
...
//
////            Emotion relatedEmotion = emotionRepository.findByEmotionResult(emotionResult);  // 여기서 emotionResult를 사용하여 찾습니다.
//            Emotion relatedEmotion = emotionRepository.findByEmotionResultAndMemberNoOrderByCreatedAtDesc(emotionResult, memberNo);
//
...
//                youtubeLink = youtubeLink.replace("%0A", "");
